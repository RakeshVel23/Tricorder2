...
def overview_server(input, output, session, data):
    ...
    def kpi_section():
        ...
        return summary_table([
            ...
            ("Active GPs", format_number(active_gps), "GPs with at least one recording"),
            ("Active GP Rate", format_rate(active_gp_rate), "Percentage of registered GPs with recordings"),
